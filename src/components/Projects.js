    ...
    <section className="project" id="projects">
        ...
        <div className="flex flex-col md:w-50% md:flex-row gap-4">
            <div className=" basis-1/2 border-border border-2 bg-foreground rounded-xl p-2">
              ...
              <a className="text-primary-content" href="https://github.com/AlvinCao88/alvin-website"> 
                <button >
                  Github
                </button>
              </a>
        ...
        <div className="flex flex-col  md:flex-row gap-4 ">
            <div className=" basis-1/2 border-border border-2 bg-foreground rounded-xl p-2">
              ...
              <a className="text-primary-content" href="https://devpost.com/software/fakeit"> 
                <button>
                  Devpost
                </button>
              </a>
            ...
            <div className=" basis-1/2 border-border border-2 bg-foreground rounded-xl p-2">
              ...
              <p>An app that allows both Store Owners and Customers to interact to place order for pick up. </p>
              <a className="text-primary-content" href="https://github.com/AlvinCao88/b07FinalProject_Group9"> 
                <button  >
                  Github
                </button>
                </a>
            ...
            <div className="  basis-1/2 border-border border-2 bg-foreground rounded-xl p-2">
              <h3>Datathon</h3>
              <p>The dataset entails usage data of 108 old batteries, with the remaining usage life values; the goal is to predict the remaining usage for 19 unknown batteries using their usage data.</p>
            </div>
        </div>
        ...
        <div className=" basis-1/2 border-border border-2 bg-foreground rounded-xl p-2">
              ...
              <p>Applied knowlegde from workshops on Sports data analysis, API and visualized the data using PowerBI</p>
            ...
            <div className=" basis-1/2 border-border border-2 bg-foreground rounded-xl p-2">
              ...
              <a className="text-primary-content" href="https://github.com/AlvinCao88/Lost-in-the-Valley"> 
                <button >
                  Github
                </button>
              </a>
              <a className="text-primary-content" href="https://devpost.com/software/loss-in-the-valley"> 
              <button>
                Devpost
              </button>
              </a>
            ...
            <div className="  basis-1/2 border-border border-2 bg-foreground rounded-xl p-2">
              ...
              <p>Learn to trade fincial securities on a real-time basisusing Rotman Interactive Trader Software.</p>
              <p>And quickly applied the knowlegde in a fast-paced, simulated trade floor.</p>
